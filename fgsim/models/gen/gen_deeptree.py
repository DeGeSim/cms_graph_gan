...
from fgsim.models.branching.graph_tree import GraphTreeGen
...
class ModelClass(nn.Module):
    ...
    def wrap_conv(self, graph: GraphTreeGen) -> Dict[str, torch.Tensor]:
        if self.conv_name == "GINConv":
            return {
    ...
    # Random vector to pc
    def forward(self, random_vector: torch.Tensor) -> GraphTreeGen:
        batch_size = self.batch_size
        ...
        graph = GraphTreeGen(x=random_vector.reshape(batch_size, features[0]))
